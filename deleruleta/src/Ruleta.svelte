...
<div class="grid grid-cols-1 m-auto w-[90vw] mt-4">
    ...
    {:else}
        {#if main_menu}
            <div class="grid grid-cols-3 place-items-center mt-8">
                <button class="w-1/2 rounded-2xl bg-dele-primary hover:bg-dele-accent text-white text-2xl px-2 py-1" on:click={() => {say_letter = true; main_menu = false;}}>Decir Letra</button>
